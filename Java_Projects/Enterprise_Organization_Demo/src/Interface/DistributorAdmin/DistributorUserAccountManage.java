 ...
 * @author Ruby
 */
public class DistributorUserAccountManage extends javax.swing.JPanel {

    /**
     * Creates new form DistributorUserAccountManage
     */
    ...
    DistributorUserAccountManage(EcoSystem b, JPanel p, UserAccount ua, Organization o, Enterprise e) {
        initComponents();
        this.p = p;
        this.b = b;
        this.ua = ua;
