 ...
 * @author Ruby
 */
public class ProviderUserAccountManage extends javax.swing.JPanel {

    /**
     * Creates new form ProviderUserAccountManage
     */
    ...
    ProviderUserAccountManage(EcoSystem b, JPanel p, UserAccount ua, Organization o, Enterprise e) {
        initComponents();
        this.p = p;
        this.b = b;
        this.ua = ua;
